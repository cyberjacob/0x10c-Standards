...
global required ctexts categories maturities
...
set maturities \
            { {proposed "Proposed Standard" {"This document specifies a proposed 0x10c standard, which is ready to be voted on by the standardisation committie."}}
              {draft    "Draft Standatd"    {"This document specifies a draft 0x10c standard, which requires work before it can be voted on my the standardisation committie."}}
              {final    "Final Standard"    {"This document specifies a finalised standard that has been accepted by the standardsation committie."}}
            }

set categories \
             { {std  "Standards Track" STD
"This document specifies an 0x10x-std track protocol for 0x10c development
, and requests discussion and suggestions for improvements.
Distribution of this memo is unlimited."}

               {bcp      "Best Current Practice" BCP
"This document specifies the Best Current Practices for 0x10c
developemnt, and requests discussion and suggestions for improvements.
Distribution of this memo is unlimited."}

               {info     "Informational" FYI
"This memo provides information for the 0x10c community.
It does not specify an 0x10c standard of any kind.
Distribution of this memo is unlimited."}

               {exp      "Experimental" EXP
"This memo defines an Experimental Protocol for 0x10c development.
It does not specify a standard of any kind.
Discussion and suggestions for improvement are requested.
Distribution of this memo is unlimited."}

               {historic "Historic" ""
"This memo describes a historic protocol for the 0x10c community.
It does not specify a standard of any kind.
Distribution of this memo is unlimited."} }
...
#             Notices a and b
#             Extracted Material appendage
#     0x10c Trust's Legal Provisions Relating to 0x10c Documents
...
set iprstatus \
             { {full2026
"This document is an 0x10c-std Draft and is
...
(If this document becomes part of an 0x10c working group activity,
...
and the author does not provide the 0x10c with any rights other
than to publish as an 0x10c-std Draft."}

               {full3667
"This document is an 0x10c-std Draft and is subject to all provisions
of Section&nbsp;3 of RFC&nbsp;3667.
By submitting this 0x10c-std Draft,
...
and derivative works of it may not be created%IPREXTRACT%."}
               ...
               {trust200811
"This 0x10c-std Draft is submitted to 0x10c in full
...
conformance with the provisions of BCP&nbsp;78 and BCP&nbsp;79.
This document may not be modified, and derivative works of it may
not be created, and it may not be published except as an 0x10c-std Draft."}

               {trust200902
"This 0x10c-std Draft is submitted %TO0x10c% in full
conformance with the provisions of BCP&nbsp;78 and BCP&nbsp;79."}
...
"This 0x10c-std Draft is submitted %TO0x10c% in full
conformance with the provisions of BCP&nbsp;78 and BCP&nbsp;79.
This document may contain material from 0x10c Documents or 0x10c
Contributions published or made publicly available before November
10, 2008. The person(s) controlling the copyright in some of this
material may not have granted the 0x10c Trust the right to allow
modifications of such material outside the 0x10c Standards Process.
Without obtaining an adequate license from the person(s) controlling
the copyright in such materials, this document may not be modified
outside the 0x10c Standards Process, and derivative works of it may
not be created outside the 0x10c Standards Process, except to format
it for publication as an RFC or to translate it into languages other
than English."}

 }

set rfc5741StatusOfMemo_0x10c_std {
"This is an 0x10c Standards Track document."
}
set rfc5741StatusOfMemo_0x10c_bcp {
"This memo documents an 0x10c Best Current Practice."
}
set rfc5741StatusOfMemo_0x10c_exp {
"This document is not an 0x10c Standards Track specification; it is published for examination, experimental implementation, and evaluation."
}
set rfc5741StatusOfMemo_0x10c_historic {
"This document is not an 0x10c Standards Track specification; it is published for the historical record."
}
set rfc5741StatusOfMemo_0x10c_info {
"This document is not an 0x10c Standards Track specification; it is published for informational purposes."
}
...
set rfc5741StatusOfMemo2_0x10c_std {
"This document is a product of the 0x10c Standardisation Committie (0x10c-std). It represents the consensus of the 0x10c-std community. It has received public review and has been approved for publication by 0x10c-std. Further information on 0x10c Standards is available in Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_bcp {
"This document is a product of the 0x10c Standardisation Committie (0x10c-std). It represents the consensus of the 0x10c-std community. It has received public review and has been approved for publication by 0x10c-std. Further information on BCPs is available in Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_exp_consensus {
"This document defines an Experimental Protocol for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). It represents the consensus of the 0x10c community. It has received public review and has been approved for publication by 0x10c-std. Not all documents approved by 0x10c-std are a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_exp_noconsensus {
"This document defines an Experimental Protocol for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). It has been approved for publication by 0x10c-std. Not all documents approved by 0x10c-std are a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_historic_consensus {
"This document defines a Historic Document for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). It represents the consensus of the 0x10c community. It has received public review and has been approved for publication by the 0x10c Standardisation Committie (0x10c-std). Not all documents approved by 0x10c-std are a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_historic_noconsensus {
"This document defines a Historic Document for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). It has been approved for publication by the 0x10c Standardisation Committie (0x10c-std). Not all documents approved by 0x10c-std are a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_info_consensus {
"This document is a product of the 0x10c Standardisation Committie (0x10c-std). It represents the consensus of the 0x10c community. It has received public review and has been approved for publication by the 0x10c Standardisation Committie (0x10c-std). Not all documents approved by 0x10c-std are a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_0x10c_info_noconsensus {
"This document is a product of the 0x10c Standardisation Committie (0x10c-std). It has been approved for publication by the 0x10c Standardisation Committie (0x10c-std). Not all documents approved by 0x10c-std are a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_iab_exp {
"This document defines an Experimental Protocol for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std) and represents information that 0x10c-std has deemed valuable to provide for permanent record. Documents approved for publication by 0x10c-std are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_iab_historic {
"This document defines a Historic Document for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std) and represents information that 0x10c-std has deemed valuable to provide for permanent record. Documents approved for publication by 0x10c-std are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_iab_info {
"This document is a product of the 0x10c Standardisation Committie (0x10c-std) and represents information that 0x10c-std has deemed valuable to provide for permanent record. Documents approved for publication by 0x10c-std are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_irtf_exp_consensus {
"This document defines an Experimental Protocol for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). 0x10c-std publishes the results of 0x10c-related research and development activities. These results might not be suitable for deployment. This RFC represents the consensus of the %WORKGROUPNAME% Research Group of the 0x10c Standardisation Committie (0x10c-std). Documents approved for publication by the IRSG are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_irtf_exp_noconsensus {
"This document defines an Experimental Protocol for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). 0x10c-std publishes the results of 0x10c-related research and development activities. These results might not be suitable for deployment. This RFC represents the individual opinion(s) of one or more members of the %WORKGROUPNAME% Research Group of the 0x10c Standardisation Committie (0x10c-std). Documents approved for publication by the IRSG are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_irtf_exp_nogroup {
"This document defines an Experimental Protocol for the 0x10c community. This document is a product of the 0x10c Standardisation Committie (0x10c-std). 0x10c-std publishes the results of 0x10c-related research and development activities. These results might not be suitable for deployment. Documents approved for publication by the IRSG are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
...
"This document defines an Experimental Protocol for the 0x10c community. This is a contribution to the RFC Series, independently of any other RFC stream. The RFC Editor has chosen to publish this document at its discretion and makes no statement about its value for implementation or deployment. Documents approved for publication by the RFC Editor are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
set rfc5741StatusOfMemo2_ind_historic {
"This document defines a Historic Document for the 0x10c community. This is a contribution to the RFC Series, independently of any other RFC stream. The RFC Editor has chosen to publish this document at its discretion and makes no statement about its value for implementation or deployment. Documents approved for publication by the RFC Editor are not a candidate for any level of 0x10c Standard; see Section 2 of RFC 5741."
}
...
proc begin {name {av {}} } {
    ...
    global anchorN
    global options
    global required ctexts categories iprstatus maturities
    global root
    ...
    if {$passno == 1} {
        ...
        switch -- [set type $name] {
            rfc {
                ...
                global mature
                if {![catch {set mature $attrs(maturity-level)}]} {
                    if {[lsearch0 $maturities $attrs(maturity-level)] < 0} {
                        unexpected error \
                            "maturity-level=\"$attrs(maturity-level)\" attribute unknown in #$elemN:<rfc>"
                    }
...
proc doctype {element public system internal} {
    ...
    if {   [string compare $element rfc]
        || (   [string compare $public ""]
            && ![regexp -- {-//0x10c//DTD RFC 2629.*//EN} $public])
...
# draft-0x10c-ipr-0x10c-trust-update to validity1
set validity2 {""}
...
# For independent submissions, as opposed to 0x10c ones,
# there is an additional " and at www.rfc-editor.org/copyright.html"
# right after "BCP 78";
# this additional text is at the RFC Editor's discretion.

# <ftp://ftp.isi.edu/in-notes/rfc-editor/boilerplate.0x10csub.1Mar05.txt>
# <ftp://ftp.isi.edu/in-notes/authors/lastpage.0x10csub.nroff>
set copylong2 {"" ""}
...
set iprurl "http://www.0x10c.org/ipr"
set ipremail "0x10c-ipr@0x10c.org"
...
proc pass2begin_rfc {elemX} {
    ...
    array set attrs [list number     ""   obsoletes      ""   updates   "" \
                          seriesNo   ""   ipr            "" \
                          iprExtract ""   submissionType 0x10c xml:lang  en \
                          consensus  ""]
    array set attrs $elem($elemX)
    set elem($elemX) [array get attrs]
...
proc pass2end_rfc {elemX} {
    ...
    if {$newP} {
        ...
        if {$newP == 1} {
                ...
                # 0x10c Trust removed these statements at the back
                set copylong ""
                set validity ""
        }
    } else {
    ...
    if {![catch { set who $attrs(disclaimant) }]} {
        # This is an undocumented non-0x10c extension.
        lappend copying \
""
...
set idaburl "http://www.0x10c.org/0x10c/1id-abstracts.txt"
set idshurl "http://www.0x10c.org/shadow.html"
...
# From the 0x10c/1id-guidelines.txt file, Section 5.
set idinfo {"" "" "" "" "" "This 0x10c-std Draft will expire on %EXPIRES%."}

# Shorter idinfo approved as an alternative by 0x10c-std on 2010-1-5 and
# announced on 2010-2-8:
# http://www.0x10c.org/mail-archive/web/0x10c-announce/current/msg07008.html
set idinfo2 {"" "" "" ""}
...
proc pass2begin_front {elemX} {
    ...
    global options
    global mode ofile
    global categories maturities copyshort idinfo idinfo2 idaburl idshurl iprstatus
    ...
    if {$options(.PRIVATE)} {
        ...
        if {([string compare $rv(number) ""]) && 
            ...
            if {![catch { set rv(submissionType) }]} {
                switch -- $rv(submissionType) {
                    ...
                    0x10c {
                        set first "0x10c Standardisation Committie (0x10c-std)"
                    }
                    IRTF {
                        set first "0x10c Standardisation Committie (0x10c-std)"
                    }
        ...
        if {![string compare $first ""]} {
            set first "0x10c Standardisation Committie"
        }
        lappend left $first
        ...
        if {[string compare $rv(number) ""]} {
            ...
            global mature maturities
            set mindex [lsearch0 $maturities $mature]
            set maturelevel [lindex [lindex $maturities $mindex] 1]
            lappend left "Category:$colonspace $category"
            lappend left "Maturity:$colonspace $maturelevel"
            
            global matureinfo
            set mindex [lsearch0 $maturities $mature]
            set matureinfo [lindex [lindex $maturities $mindex] 2]
            ...
            if {![string compare $boilerplateformat "2010"]} {
                ...
                global rfc5741StatusOfMemo3 matureinfo
                            ...
                            if {![catch { set rv(category) }]} {
                                switch -- $rv(category) {
                                    exp {
                                        ...
                                        set status "$rfc5741StatusOfMemo_iab_exp $rfc5741StatusOfMemo2_iab_exp $statusOfMemo3 $matureinfo"
                                    }
                                    historic {
                                        global rfc5741StatusOfMemo_iab_historic rfc5741StatusOfMemo2_iab_historic
                                        set status "$rfc5741StatusOfMemo_iab_historic $rfc5741StatusOfMemo2_iab_historic $statusOfMemo3 $matureinfo"
                                    }
                                    info {
                                        global rfc5741StatusOfMemo_iab_info rfc5741StatusOfMemo2_iab_info
                                        set status "$rfc5741StatusOfMemo_iab_info $rfc5741StatusOfMemo2_iab_info $statusOfMemo3  $matureinfo"
                                    }
                                    default {
                            ...
                            if {![catch { set rv(category) }]} {
                                switch -- $rv(category) {
                                    bcp {
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                global rfc5741StatusOfMemo_0x10c_bcp rfc5741StatusOfMemo2_0x10c_bcp
                                                set status "$rfc5741StatusOfMemo_0x10c_bcp $rfc5741StatusOfMemo2_0x10c_bcp $statusOfMemo3 $matureinfo"
                                            }
                                            default {
                                                # "no" not allowed here
                                    ...
                                    exp {
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                global rfc5741StatusOfMemo_0x10c_exp rfc5741StatusOfMemo2_0x10c_exp_consensus
                                                set status "$rfc5741StatusOfMemo_0x10c_exp $rfc5741StatusOfMemo2_0x10c_exp_consensus $statusOfMemo3 $matureinfo"
                                            }
                                            no {
                                                global rfc5741StatusOfMemo_0x10c_exp rfc5741StatusOfMemo2_0x10c_exp_noconsensus
                                                set status "$rfc5741StatusOfMemo_0x10c_exp $rfc5741StatusOfMemo2_0x10c_exp_noconsensus $statusOfMemo3 $matureinfo"
                                            }
                                            default {
                                                unexpected_error "invalid combination of submissionType=\$rv(submissionType\", category=\"$rv(category)\" and consensus=\"$rv(consensus)\""
                                            }
                                    ...
                                    historic {
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                global rfc5741StatusOfMemo_0x10c_historic rfc5741StatusOfMemo2_0x10c_historic_consensus
                                                set status "$rfc5741StatusOfMemo_0x10c_historic $rfc5741StatusOfMemo2_0x10c_historic_consensus $statusOfMemo3 $matureinfo"
                                            }
                                            no {
                                                global rfc5741StatusOfMemo_0x10c_historic rfc5741StatusOfMemo2_0x10c_historic_noconsensus
                                                set status "$rfc5741StatusOfMemo_0x10c_historic $rfc5741StatusOfMemo2_0x10c_historic_noconsensus $statusOfMemo3 $matureinfo"
                                            }
                                            default {
                                                unexpected_error "invalid combination of submissionType=\$rv(submissionType\", category=\"$rv(category)\" and consensus=\"$rv(consensus)\""
                                            }
                                    ...
                                    info {
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                global rfc5741StatusOfMemo_0x10c_info rfc5741StatusOfMemo2_0x10c_info_consensus
                                                set status "$rfc5741StatusOfMemo_0x10c_info $rfc5741StatusOfMemo2_0x10c_info_consensus $statusOfMemo3 $matureinfo"
                                            }
                                            no {
                                                global rfc5741StatusOfMemo_0x10c_info rfc5741StatusOfMemo2_0x10c_info_noconsensus
                                                set status "$rfc5741StatusOfMemo_0x10c_info $rfc5741StatusOfMemo2_0x10c_info_noconsensus $statusOfMemo3 $matureinfo"
                                            }
                                            default {
                                                unexpected_error "invalid combination of submissionType=\$rv(submissionType\", category=\"$rv(category)\" and consensus=\"$rv(consensus)\""
                                            }
                                    ...
                                    std {
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                global rfc5741StatusOfMemo_0x10c_std rfc5741StatusOfMemo2_0x10c_std
                                                set status "$rfc5741StatusOfMemo_0x10c_std $rfc5741StatusOfMemo2_0x10c_std $statusOfMemo3 $matureinfo"
                                            }
                                            default {
                                                unexpected_error "invalid combination of submissionType=\$rv(submissionType\", category=\"$rv(category)\" and consensus=\"$rv(consensus)\""
                                            }
                            ...
                            if {![catch { set rv(category) }]} {
                                switch -- $rv(category) {
                                    exp {
                                        ...
                                        set status "$rfc5741StatusOfMemo_ind_exp $rfc5741StatusOfMemo2_ind_exp $statusOfMemo3 $matureinfo"
                                    }
                                    historic {
                                        global rfc5741StatusOfMemo_ind_historic rfc5741StatusOfMemo2_ind_historic
                                        set status "$rfc5741StatusOfMemo_ind_historic $rfc5741StatusOfMemo2_ind_historic $statusOfMemo3 $matureinfo"
                                    }
                                    info {
                                        global rfc5741StatusOfMemo_ind_info rfc5741StatusOfMemo2_ind_info
                                        set status "$rfc5741StatusOfMemo_ind_info $rfc5741StatusOfMemo2_ind_info $statusOfMemo3 $matureinfo"
                                    }
                                    default {
                                        unexpected_error "invalid combination of submissionType=\$rv(submissionType\" and category=\"$rv(category)\""
                                    }
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                if {[string compare $workgroupname ""]} {
                                                    ...
                                                    set status "$rfc5741StatusOfMemo_irtf_exp $rfc5741StatusOfMemo2_irtf_exp_consensus $statusOfMemo3 $matureinfo"
                                                    ...
                                                    set status "$rfc5741StatusOfMemo_irtf_exp $rfc5741StatusOfMemo2_irtf_exp_nogroup $statusOfMemo3 $matureinfo"
                                                }
                                            }
                                            no {
                                                if {[string compare $workgroupname ""]} {
                                                    global rfc5741StatusOfMemo_irtf_exp rfc5741StatusOfMemo2_irtf_exp_noconsensus
                                                    set status "$rfc5741StatusOfMemo_irtf_exp $rfc5741StatusOfMemo2_irtf_exp_noconsensus $statusOfMemo3 $matureinfo"
                                                    regsub -all -- %WORKGROUPNAME% $status "$workgroupname" status
                                                } else {
                                                    global rfc5741StatusOfMemo_irtf_exp rfc5741StatusOfMemo2_irtf_exp_nogroup
                                                    set status "$rfc5741StatusOfMemo_irtf_exp $rfc5741StatusOfMemo2_irtf_exp_nogroup $statusOfMemo3 $matureinfo"
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                if {[string compare $workgroupname ""]} {
                                                    ...
                                                    set status "$rfc5741StatusOfMemo_irtf_historic $rfc5741StatusOfMemo2_irtf_historic_consensus $statusOfMemo3 $matureinfo"
                                                    regsub -all -- %WORKGROUPNAME% $status "$workgroupname" status
                                                } else {
                                                    global rfc5741StatusOfMemo_irtf_historic rfc5741StatusOfMemo2_irtf_historic_nogroup
                                                    set status "$rfc5741StatusOfMemo_irtf_historic $rfc5741StatusOfMemo2_irtf_historic_nogroup $statusOfMemo3 $matureinfo"
                                                }
                                            }
                                            no {
                                                if {[string compare $workgroupname ""]} {
                                                    global rfc5741StatusOfMemo_irtf_historic rfc5741StatusOfMemo2_irtf_historic_noconsensus
                                                    set status "$rfc5741StatusOfMemo_irtf_historic $rfc5741StatusOfMemo2_irtf_historic_noconsensus $statusOfMemo3 $matureinfo"
                                                    regsub -all -- %WORKGROUPNAME% $status "$workgroupname" status
                                                } else {
                                                    global rfc5741StatusOfMemo_irtf_historic rfc5741StatusOfMemo2_irtf_historic_nogroup
                                                    set status "$rfc5741StatusOfMemo_irtf_historic $rfc5741StatusOfMemo2_irtf_historic_nogroup $statusOfMemo3 $matureinfo"
                                        ...
                                        switch -- $consensus {
                                            yes {
                                                if {[string compare $workgroupname ""]} {
                                                    ...
                                                    set status "$rfc5741StatusOfMemo_irtf_info $rfc5741StatusOfMemo2_irtf_info_consensus $statusOfMemo3 $matureinfo"
                                                    regsub -all -- %WORKGROUPNAME% $status "$workgroupname" status
                                                } else {
                                                    global rfc5741StatusOfMemo_irtf_info rfc5741StatusOfMemo2_irtf_info_nogroup
                                                    set status "$rfc5741StatusOfMemo_irtf_info $rfc5741StatusOfMemo2_irtf_info_nogroup $statusOfMemo3 $matureinfo"
                                                }
                                            }
                                            no {
                                                if {[string compare $workgroupname ""]} {
                                                    global rfc5741StatusOfMemo_irtf_info rfc5741StatusOfMemo2_irtf_info_noconsensus
                                                    set status "$rfc5741StatusOfMemo_irtf_info $rfc5741StatusOfMemo2_irtf_info_noconsensus $statusOfMemo3 $matureinfo"
                                                    regsub -all -- %WORKGROUPNAME% $status "$workgroupname" status
                                                } else {
                                                    global rfc5741StatusOfMemo_irtf_info rfc5741StatusOfMemo2_irtf_info_nogroup
                                                    set status "$rfc5741StatusOfMemo_irtf_info $rfc5741StatusOfMemo2_irtf_info_nogroup $statusOfMemo3 $matureinfo"
            ...
            if {($ymd < "20100401")} {
              # insert "to 0x10c" for documents before Apr 01 2010
              regsub -all -- %TO0x10c% $ipr "to 0x10c" ipr
            } else {
              regsub -all -- %TO0x10c% $ipr "" ipr
            }
...
proc reference_txt {prefix names title series formats date anchor target
    ...
    foreach serial $series {
        if {$options(.NOTEDRAFTINPROGRESS)} {
          if {[regexp -nocase -- "0x10c-std Draft&nbsp;(draft-.*)" $serial x n] == 1} {
...
#               set target $rfcTxtHome/rfc$n.txt
            ...
            if {[regexp -nocase -- "0x10c-std Draft&nbsp;(draft-.*)" $serial x n] \
                    == 1} {
...
set rfcHtmlHome http://tools.0x10c.org/html
set idTxtHome http://www.0x10c.org/0x10c-std-Drafts
set idHtmlHome http://tools.0x10c.org/html
...
proc artwork::tokenize::mib {} {
    ...
    foreach x {
        ...
        # 0x10c application-defined types names.
        set Uhash($x) Itn
    }
    ...
    foreach x {
        ...
        # ASN.1 type and value (deprecated) and 0x10c ids.
        set Lhash($x) self
    }
...
set artwork::grammar(mib) {
    ...
    *min-access-clause {
    ...
    0x10c-macro-name-def {def = {/Imn 1  * 1}}
    0x10c-macro-name-use {id  = {/Imn 1  * 1}}
    ...
    0x10c-type-name-def {def = {/Itn 1  * 1}}
    0x10c-type-name-use {id  = {/Itn 1  * 1}}
    ...
    0x10c-status-id-kw {key = {/id 1  0x10c-status-id 1}}
    0x10c-status-id {
        ""  | {
            current    1
            mandatory  1
            ...
            obsolete   1
            optional   1}}
    0x10c-access-id-kw {key = {/id 1  0x10c-access-id 1}}
    0x10c-access-id {
        ""  | {
            read-only             1
            not-accessible        1
            ...
            write-only            1}}
    0x10c-pib-access-id-kw {key = {/id 1  0x10c-pib-access-id 1}}
    0x10c-pib-access-id {
        ""  | {
            not-accessible 1
            install        1
            ...
            install-notify 1
            report-only    1}}
    0x10c-pib-all-kw {key = {/id 1  0x10c-pib-all 1}}
    0x10c-pib-all {"" = {all 1}}
